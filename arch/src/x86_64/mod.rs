...
pub fn arch_memory_regions(size: GuestUsize) -> Vec<(GuestAddress, usize, RegionType)> {
    let reserved_memory_gap_start = super::MEM_32BIT_GAP_START
        .checked_add(super::MEM_32BIT_DEVICES_GAP_SIZE)
    ...
    if size as u64 <= super::MEM_32BIT_GAP_START.raw_value() {
    ...
    // case2: guest memory extends beyond the gap
        ...
        regions.push((
            GuestAddress(0),
            super::MEM_32BIT_GAP_START.raw_value() as usize,
            RegionType::Ram,
        ));
        regions.push((
            FIRST_ADDR_PAST_32BITS,
            requested_memory_size.unchecked_offset_from(super::MEM_32BIT_GAP_START) as usize,
            RegionType::Ram,
        ));
    }
    ...
    regions.push((
        super::MEM_32BIT_GAP_START,
        super::MEM_32BIT_DEVICES_GAP_SIZE as usize,
    ...
    regions.push((
        ...
        (MEM_32BIT_GAP_SIZE - super::MEM_32BIT_DEVICES_GAP_SIZE) as usize,
        RegionType::Reserved,
    ));
