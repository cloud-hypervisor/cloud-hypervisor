...
use crate::engine::{AioEngine, RawFileDisk, Wrapper};

pub type RawDiskAsyncAio = RawFileDisk<AioEngine>;
pub type RawFileAsyncAio = Wrapper<AioEngine>;
...
mod unit_tests {
    ...
    fn test_punch_hole() {
        ...
        let mut async_io = RawFileAsyncAio::new(file.try_clone().unwrap(), 128).unwrap();
