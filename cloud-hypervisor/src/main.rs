...
use vmm::vm_config::{
    ...
    PciSegmentConfig, PmemConfig, RateLimiterGroupConfig, TpmConfig, UserDeviceConfig,
    UserVhostDeviceConfig, VdpaConfig, VmConfig, VsockConfig,
};
...
fn get_cli_options_sorted(
    ...
    [
        ...
        Arg::new("user-device")
            ...
            .num_args(1..)
            .group("vm-config"),
        Arg::new("user-vhost-device")
            .long("user-vhost-device")
            .help(UserVhostDeviceConfig::SYNTAX)
            .num_args(1..)
            .group("vm-config"),
        Arg::new("v")
            .short('v')
