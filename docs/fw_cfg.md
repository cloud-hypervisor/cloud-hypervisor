...
The `fw_cfg` device serves as a generic information channel between the hypervisor and the guest. It can be used to:

*   Load the kernel, initramfs, and kernel command line for direct kernel boot scenarios.
