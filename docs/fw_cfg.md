...
2.  **Inline string items (e.g., OVMF MMIO64 configuration for GPU passthrough):**
    ...
    cloud-hypervisor \
        ...
        ...
    ```
    The string `262144` is passed directly to the guest as the content of `opt/ovmf/X-PciMmio64Mb`. See [nvidia-cc.md](nvidia-cc.md) for the full GPU CC passthrough workflow.
