...
pushd "${KOKORO_CHV_DIR}/google_internal/kokoro"
...
args=(
  --bazelrc="${KOKORO_CHV_DIR}/google_internal/.bazelrc"
  build
  --config=kokoro
...
export SWARMING_TASK_PREFIX="Kokoro_PR${KOKORO_GERRIT_CHANGE_NUMBER}"
