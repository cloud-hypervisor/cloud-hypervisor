...
impl OptionParser {
    ...
    fn parse_inner(&mut self, ignore_unknown: bool, input: &str) -> OptionParserResult<()> {
    ...
    pub fn extend(&mut self, options: &[&str]) -> &mut Self {
