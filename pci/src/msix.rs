...
const MAX_MSIX_VECTORS_PER_DEVICE: u16 = 0x800;
...
impl MsixConfig {
    pub fn new(msix_vectors: u16) -> Self {
        ...
        pba_entries.resize_with(msix_vectors as usize, Default::default);
    ...
    pub fn read_table(&mut self, offset: u64, data: &mut [u8]) {
        ...
        //println!("###_MSI_R TABLE offset 0x{:x} data 0x{:x}", offset, value);
    ...
    pub fn write_table(&mut self, offset: u64, data: &[u8]) {
        ...
        //println!("###_MSI_W TABLE offset 0x{:x} data 0x{:x}", offset, value);
    }
    ...
    pub fn read_pba(&mut self, offset: u64, data: &mut [u8]) {
        ...
        match data.len() {
            4 => {
                ...
                //println!("###_MSI_R PBA offset 0x{:x} data 0x{:x}", offset, value);
                LittleEndian::write_u32(data, value);
            }
            8 => {
    ...
    pub fn write_pba(&mut self, offset: u64, data: &[u8]) {
        ...
        match data.len() {
            4 => {
                ...
                //println!("###_MSI_W PBA offset 0x{:x} data 0x{:x}", offset, value);
            }
            8 => {
