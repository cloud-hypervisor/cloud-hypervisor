        ...
        for mmio_region in &mut self.common.mmio_regions {
            ...
            if region_flags & VFIO_REGION_INFO_FLAG_MMAP != 0 {
                ...
                for s in mmaps.iter() {
                    ...
                    unsafe {
                        // SAFETY: the arguments are valid due to internal invariants.
                        // TODO: specify these invariants.
                        ...
                        // SAFETY: the memory region was created by
