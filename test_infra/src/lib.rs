...
pub mod x86_64 {
    ...
    pub const NOBLE_IMAGE_NAME: &str = "noble-server-cloudimg-amd64-custom-20260601-0.raw";
    pub const NOBLE_IMAGE_NAME_VHD: &str = "noble-server-cloudimg-amd64-custom-20260601-0.vhd";
    pub const NOBLE_IMAGE_NAME_VHDX: &str = "noble-server-cloudimg-amd64-custom-20260601-0.vhdx";
    pub const NOBLE_IMAGE_NAME_QCOW2: &str = "noble-server-cloudimg-amd64-custom-20260601-0.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_ZLIB: &str =
        "noble-server-cloudimg-amd64-custom-20260601-0-zlib.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_ZSTD: &str =
        "noble-server-cloudimg-amd64-custom-20260601-0-zstd.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_BACKING_ZSTD_FILE: &str =
        "noble-server-cloudimg-amd64-custom-20260601-0-backing-zstd.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_BACKING_UNCOMPRESSED_FILE: &str =
        "noble-server-cloudimg-amd64-custom-20260601-0-backing-uncompressed.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_BACKING_RAW_FILE: &str =
        "noble-server-cloudimg-amd64-custom-20260601-0-backing-raw.qcow2";
...
#[cfg(target_arch = "aarch64")]
pub mod aarch64 {
    pub const NOBLE_IMAGE_NAME: &str = "noble-server-cloudimg-arm64-custom-20260601-0.raw";
    pub const NOBLE_IMAGE_NAME_VHD: &str = "noble-server-cloudimg-arm64-custom-20260601-0.vhd";
    pub const NOBLE_IMAGE_NAME_VHDX: &str = "noble-server-cloudimg-arm64-custom-20260601-0.vhdx";
    pub const NOBLE_IMAGE_NAME_QCOW2: &str = "noble-server-cloudimg-arm64-custom-20260601-0.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_ZLIB: &str =
        "noble-server-cloudimg-arm64-custom-20260601-0-zlib.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_ZSTD: &str =
        "noble-server-cloudimg-arm64-custom-20260601-0-zstd.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_BACKING_ZSTD_FILE: &str =
        "noble-server-cloudimg-arm64-custom-20260601-0-backing-zstd.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_BACKING_UNCOMPRESSED_FILE: &str =
        "noble-server-cloudimg-arm64-custom-20260601-0-backing-uncompressed.qcow2";
    pub const NOBLE_IMAGE_NAME_QCOW2_BACKING_RAW_FILE: &str =
        "noble-server-cloudimg-arm64-custom-20260601-0-backing-raw.qcow2";
