...
impl RtcEpollHandler {
    ...
    fn handle_request(&self, req: &VirtioRtcRequest) -> VirtioRtcResponse {
        match req {
            ...
            VirtioRtcRequest::ClockCap { clock_id } => {
                if *clock_id >= NUM_CLOCKS {
                    return VirtioRtcResponse::ClockCap(VirtioRtcRespClockCap {
                        head: VirtioRtcRespHead {
                ...
                VirtioRtcResponse::ClockCap(VirtioRtcRespClockCap {
                    head: VirtioRtcRespHead {
                        status: VIRTIO_RTC_S_OK,
                        ..Default::default()
                    },
            ...
            VirtioRtcRequest::Read { clock_id } => {
                if *clock_id >= NUM_CLOCKS {
            ...
            VirtioRtcRequest::CrossCap { clock_id, .. } => {
                if *clock_id >= NUM_CLOCKS {
                    return VirtioRtcResponse::CrossCap(VirtioRtcRespCrossCap {
                        head: VirtioRtcRespHead {
                            status: VIRTIO_RTC_S_ENODEV,
                            ..Default::default()
                        },
                ...
                VirtioRtcResponse::CrossCap(VirtioRtcRespCrossCap {
                    head: VirtioRtcRespHead {
                        status: VIRTIO_RTC_S_OK,
                        ..Default::default()
                    },
