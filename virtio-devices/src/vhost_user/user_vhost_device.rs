...
pub struct State {
    ...
    pub config: VirtioUserVhostConfig,
...
#[repr(C, packed)]
pub struct VirtioUserVhostConfig {
    pub num_request_queues: u32,
}

// SAFETY: only a series of integers
unsafe impl ByteValued for VirtioUserVhostConfig {}

pub struct UserVhost {
    common: VirtioCommon,
    vu_common: VhostUserCommon,
    id: String,
    config: VirtioUserVhostConfig,
...
impl UserVhost {
    ...
    pub fn new(
        ...
        let (
            ...
            info!("Restoring user-vhost-device {id}");
            ...
            if num_queues > backend_num_queues {
                error!(
                    "user-vhost-device requested too many queues ({num_queues}) \
since the backend only supports {backend_num_queues}\n",
            ...
            (
                ...
                acked_protocol_features,
                num_queues,
                VirtioUserVhostConfig {
                    num_request_queues: num_queues as u32,
                },
                false,
            )
        };
...
impl VirtioDevice for UserVhost {
    ...
    fn read_config(&self, offset: u64, mut data: &mut [u8]) {
        ...
        {
            error!("Failed getting user-vhost-device configuration: {e}");
        }
    }
    ...
    fn write_config(&mut self, offset: u64, data: &[u8]) {
        ...
        {
            error!("Failed setting user-vhost-device configuration: {e:?}");
        }
    }
