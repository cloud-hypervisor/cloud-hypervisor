...
pub struct State {
    ...
    pub config: VirtioVhostUserConfig,
...
unsafe impl ByteValued for VirtioVhostUserConfig {}
...
impl VhostUser {
    /// Create a new virtio-vhost-user device.
    ...
    pub fn new(
        ...
        let (
            ...
            info!("Restoring vhost-user-device {id}");
            ...
            if num_queues > backend_num_queues {
                error!(
                    "vhost-user-device requested too many queues ({num_queues}) \
...
impl VirtioDevice for VhostUser {
    ...
    fn read_config(&self, offset: u64, mut data: &mut [u8]) {
        ...
        {
            error!("Failed getting vhost-user-device configuration: {e}");
        }
    }
    ...
    fn write_config(&mut self, offset: u64, data: &[u8]) {
        ...
        {
            error!("Failed setting vhost-user-device configuration: {e:?}");
        }
    }
...
impl Snapshottable for VhostUser {
    fn id(&self) -> String {
        self.id.clone()
    }
...
impl Transportable for VhostUser {}

impl Migratable for VhostUser {
