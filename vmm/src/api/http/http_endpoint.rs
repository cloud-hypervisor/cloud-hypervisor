...
use crate::external_fds::{ExternalFdOperation, ExternalFds, ScmRights, UpdateFds};
            ...
            Method::Put => {
                match &req.body {
                    Some(body) => {
                        ...
                        if let Err(error) = vm_config.consume_fds(Vec::new()) {
