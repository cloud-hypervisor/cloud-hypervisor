...
use api_types::{
    ConsoleOutputMode, CpusConfigParseError, MemoryRestoreMode, RestoredNetConfig,
...
pub enum Error {
    ...
    ParseCpus(#[from] CpusConfigParseError),
...
impl From<api_types::RestoreConfig> for RestoreConfig {
    fn from(value: api_types::RestoreConfig) -> Self {
        Self {
            source_url: value.source_url,
            prefault: value.prefault,
            memory_restore_mode: value.memory_restore_mode,
            net_fds: value.net_fds,
...
mod unit_tests {
    ...
    use api_types::{
        CpuTopology, CpusConfig, HotplugMethod, MemoryZoneConfig, NumaDistance, VhostMode,
