...
use crate::migration::cancel::{CancelContextReceiver, CancelContextSender, new_cancel_context};
...
pub struct MigrationWorkerHandle {
    ...
    cancel_ctx: CancelContextSender,
}
...
impl MigrationWorker {
    ...
    pub fn spawn(
        ...
        let (cancel_ctx_sender, cancel_ctx_receiver) = new_cancel_context();
        ...
        let worker = MigrationWorker {
            ...
            initial_vm_state,
            seccomp_filters,
            cancel_ctx: cancel_ctx_receiver,
        };
