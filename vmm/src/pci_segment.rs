...
impl PciSegment {
    ...
    /// Allocates a device's BDF on this PCI segment.
    ///
...
mod unit_tests {
    ...
    #[test]
    // Test to acquire a BDF with a specific device ID
    ...
    #[test]
    // Test to acquire a BDF with a device id, that is invalid, one already that
    // is already taken and one being greater then the number of allowed devices
    // per bus.
