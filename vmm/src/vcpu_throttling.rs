...
impl VcpuThrottleThreadHandle {
    ...
    fn thread_fn_inner(
        ...
        loop {
            ...
            // pause vCPUs
            Self::run_min_execution_time_or_sleep(throttle_callback, Duration::from_millis(wait_ms_vcpus));
            // let vCPUs run
            Self::run_min_execution_time_or_sleep(unthrottle_callback, Duration::from_millis(wait_ms_thread));
        }
    }
