...
pub struct GenericConfig {
    pub tag: String,
    pub socket: PathBuf,
    #[serde(default = "default_genericconfig_num_queues")]
    pub num_queues: usize,
    #[serde(default = "default_genericconfig_queue_size")]
    pub queue_size: u16,
    #[serde(default)]
    pub id: Option<String>,
    #[serde(default)]
...
pub fn default_genericconfig_num_queues() -> usize {
    1
}

pub fn default_genericconfig_queue_size() -> u16 {
    1024
}
